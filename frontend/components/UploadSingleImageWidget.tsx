            ...
            >
              <Popover.Panel static>
                  ...
                  {secureUrl === "" ? (
                    <>
                      {uploading ? (
                        <div className="flex justify-center gap-1 text-sm">
                          <CloudUploadIconOutline className="w-6" />
                            ...
                            >
                              <div className="flex flex-col justify-center items-center">
                                ...
                                <p className="text-xs text-gray-500 px-1">
                                  Please select a file to upload, and we shall
                    ...
                    <>
                      <input
                        ...
                        type="text"
                        className="cursor caret-transparent text-xs w-full py-2 px-4"
                        contentEditable={false}
                        defaultValue={secureUrl}
                      />
                      <div className="mt-3 text-xs">
                        * Tap above to copy link to clipboard
                      </div>
                ...
                <div className="text-gray-200">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="absolute w-10 top-6 right-4"
                    viewBox="0 0 88 75"
                    fill="none"
                  >
                    <path
