import { BookOpenIcon, HeartIcon, ChatBubbleBottomCenterIcon, CalendarDaysIcon } from "@heroicons/react/24/outline";
            ...
            <div className='sm:col-span-3 break-words h-full'>
                ...
                <div className="flex items-center gap-2 text-xs text-gray-400 mt-1">
                    <div className="flex items-center gap-1">
                        <CalendarDaysIcon className="w-5" /> {new Date(parseFloat(post.published_on) * 1000).toDateString()}
