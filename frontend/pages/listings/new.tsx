...
import AddOrEditListingScreen, { NewListingScreenInput } from "../../components/NewListingScreen";
import { CreateOrEditListingInput, ListingType, Mutation, PriceCurrency } from "../../graphql/generated_graphql_types";
import { gql, useMutation } from "@apollo/client";
import { useRouter } from "next/router";
import { getErrorMessageFromApolloError } from "../../utils/getErrorMessageFromApolloError";
import { toast } from "react-toastify";
import { DETAILED_LISTING, MANAGE_PRODUCT_LISTING_CONTENT } from "../../config/ScreenRoutes";
...
const NewListing = () => {
    ...
    const [mutateFunction] = useMutation<Mutation, { payload: CreateOrEditListingInput }>(createOrEditListing)
        ...
        mutateFunction({
            ...
            onCompleted(data) {
                if(val.listing_type===ListingType.Service){
                    ...
                    router.push(DETAILED_LISTING(val.listing_type, data.createOrEditListing.id))
                }else{
                    router.push(MANAGE_PRODUCT_LISTING_CONTENT(data.createOrEditListing.id))
                }
            },
        })
    }
    ...
    return (
        <div>
            ...
            <AddOrEditListingScreen initialValues={{
                ...
                video_duration: 0,
                tags: [],
                cover_image_url: "https://unsplash.com/photos/1_CMoFsPfso/download?ixid=MnwxMjA3fDB8MXxzZWFyY2h8MTd8fHByb2R1Y3QlMjBhbmQlMjBzZXJ2aWNlc3xlbnwwfHx8fDE2NjEyODAyNDM&force=true&w=1920",
            }}
