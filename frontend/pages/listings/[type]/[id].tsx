...
const Listings = () => {
    ...
    return (
        <>
            ...
            {!loading && data && data.getListingInfoById && <div className="max-w-4xl mx-auto">
                <ProductAndServiceDetailed
                    ...
                    data={{
                        ...
                        includes_chat_support: data.getListingInfoById.includes_chat_support,
                        includes_video_call_support: data.getListingInfoById.includes_video_call_support,
                        ...
                        isAdmin: userData?.getCurrentUser?.id === data.getListingInfoById.author_id,
