    ...
    return (
        ...
        <div>
            ...
            <div className="max-w-2xl mx-auto px-4">
                ...
                <div className="text-2xl font-black my-5 mb-6">Products and services bought</div>


                {loading && <Loading text="Crunching latest data..." />}


                {data?.getListingsBought && data?.getListingsBought.length === 0 && <div className="alert max-w-3xl my-2 mx-auto alert-info">You have not bought any listings yet!</div>}

                {data?.getListingsBought && !!data?.getListingsBought.length && data?.getListingsBought.map((e, indx) => (
                        ...
                        <div className='flex gap-4 cursor-pointer border border-gray-500 bg-gray-100 py-3 px-2 my-4 hover:bg-gray-200'>
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="text-xs flex gap-1 items-center text-gray-400">
                                    <div>Product By:</div> <UserAvatar user={e.author} avatarClassName='w-5' textClassName="text-xs text-gray-400" />
                                </div>
                            </div>
                        </div>
                    </Link>
