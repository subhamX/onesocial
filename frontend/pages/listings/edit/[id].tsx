...
import { CreateOrEditListingInput, ListingType, Mutation, PriceCurrency, Query, QueryGetListingInfoByIdArgs } from "../../../graphql/generated_graphql_types";
...
const EditListing = () => {
    ...
    return (
        <div>
            ...
            {data?.getListingInfoById && <AddOrEditListingScreen
                handleSubmit={handleListingUpdate}
                initialValues={{
                    ...data.getListingInfoById,
                    tags: data.getListingInfoById.tags.map(tag => ({ value: tag, label: tag })),
                }} />}
