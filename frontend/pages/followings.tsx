...
import { Query, QueryGetMyFollowingsArgs } from "../graphql/generated_graphql_types"
    ...
    return (
        <div>
            ...
            <div className="max-w-2xl mx-auto px-4 mt-5">
                ...
                {data?.getMyFollowings && data?.getMyFollowings.length === 0 && <div className="alert max-w-3xl my-2 mx-auto alert-info">You are not following anyone yet!</div>}



                {data?.getMyFollowings && data?.getMyFollowings.length !==0 && <div className="max-w-xl mx-auto">
                    {data?.getMyFollowings && !!data?.getMyFollowings.length && data?.getMyFollowings.map((e, indx) => (
                    ...
                    {hasMore && <div className='mb-10'>
                        ...
                        {hasMore ? <button className="btn btn-sm lowercase btn-primary" onClick={() => fetchMore({
                            ...
                            if (e.data.getMyFollowings.length < 10) setHasMore(false);
