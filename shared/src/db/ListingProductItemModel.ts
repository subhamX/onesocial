...
const listingProductItemModelSchema = new Schema(ListingProductItemModel, {
...
export const listingProductItemModelRepository=dbClient.fetchRepository(listingProductItemModelSchema)
